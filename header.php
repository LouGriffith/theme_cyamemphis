...
<header class="contain-to-grid page-top sticky">
	...
	<nav class="top-bar" data-topbar>
	    <ul class="title-area">
	        <li class="name">
	        	<h1><a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"><i class="icon-logo-horizontal"><span><?php bloginfo( 'name' ); ?><span></i></a></h1>
	        </li>
