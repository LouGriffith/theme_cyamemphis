...
require_once('lib/admin.php'); // filter default wordpress menu classes and clean wp_nav_menu markup

require_once('lib/custom-post-types.php'); // load Foundation specific functions like top-bar
require_once('lib/custom-taxonomy.php'); // load Foundation specific functions like top-bar
require_once('lib/custom-fields.php'); // load Foundation specific functions like top-bar
...
if( ! function_exists( 'reverie_theme_support' ) ) {
    function reverie_theme_support() {
        ...
        add_image_size('fd-featured', 800, 400, true);
        ...
        register_nav_menus(array(
            ...
            'services' => __('Services Navigation', 'reverie')
        ));
...
// create widget areas: sidebar, pagetop
